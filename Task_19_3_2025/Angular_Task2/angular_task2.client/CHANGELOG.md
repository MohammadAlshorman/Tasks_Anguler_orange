...
- Create Angular project with ng: `ng new angular_task2.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angular_task2.client.esproj`).
