...
- Create Angular project with ng: `ng new task_16_3_2025.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`task_16_3_2025.client.esproj`).
